...
exports.deleteController = exports.readAllController = exports.updateController = exports.readOneController = exports.createController = void 0;
...
const createController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, cart_1.createService)(req.body);
        res.status(201).json({
            status: true,
...
const readAllController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const products = yield (0, cart_1.readAllService)();
        res.json({
            status: true,
            data: products,
        });
...
const readOneController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const message = yield (0, cart_1.readOneService)(username);
        res.json(message);
    }
    catch (error) {
        winston_1.default.error(error, `${error}`);
...
const updateController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, cart_1.updateService)(req.params.id, req.body);
        res.json({
            status: true,
...
const deleteController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, cart_1.deleteService)(req.params.id);
        res.json({
            status: true,
